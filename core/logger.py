...
# EXAMPLES OF HOW TO SET THE LOGGER LEVEL (COPY & PASTE ONE OF THESE AT THE START OF THE .PY FILE)
...
# XAMPLES OF HOW TO PRINT A LOG (paste this into your python file and change the log message)
