...
def deploy_contract(w3, contract_interface):
    ...
    address = w3.eth.getTransactionReceipt(tx_hash)[None]
    return address
...
w3 = Web3(Web3.IPCProvider("/home/veda-sadhak/Desktop/geth/data/geth.ipc"))
...
print("Contract interface: {}".format(contract_interface))
