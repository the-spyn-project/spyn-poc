...
class ESPCN(object):
    ...
    def build_model(self):
        ...
        with tf.device(self.device): # ===================================================================================== -> All the code is running on the device specified (under the device scope)
    ...
    def train(self, config, sess):
        ...
        if config.is_train:
            ...
            if step > 0 and step % 10 == 0:
                ...
                print("step: " + str(step) + " loss: " + str(loss) + " timestamp: " + str(datetime.datetime.now()))
